...
st.sidebar.html("<p>In this model Dependent Feature is <bold>Price</bold>.so, I used Regression Algorithm.And Independent Variables are bedrooms, bathrooms, sqft_living, floors, sqft_lot.</p>")
